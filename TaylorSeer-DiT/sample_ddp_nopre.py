...
from models_nopre import DiT_models
...
def main(args):
    ...
    ckpt_path = args.ckpt or f"/root/paddlejob/workspace/env_run/gxl/TaylorSeer/TaylorSeer-DiT/pretrained_models/DiT-XL-2-{args.image_size}x{args.image_size}.pt"
    ...
    folder_name = f"{args.mode}_nopre-rel{args.threshold}-mid_cor{args.mid_cor}-max_block_order{args.max_block_order}-inter{args.interval}-max_order{args.max_order}" \
